<template>
	<div>
	<ul>
		<router-link tag="li" to="news" activeClass="active">新闻</router-link>
		<router-link tag="li" to="/review" activeClass="active">预告片</router-link>
		<router-link tag="li" to="/find/toplist" activeClass="active">排行榜</router-link>
